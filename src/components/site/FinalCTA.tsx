  ...
  return (
    ...
    >
      ...
      <div className="container-narrow relative text-center max-w-2xl">
        <h2 className="font-display font-extrabold text-4xl md:text-5xl lg:text-6xl tracking-tight leading-[1.1] text-white">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-sm text-white/75">
          <a
            ...
            dir="ltr"
          >
            <MessageCircle className="h-4 w-4 text-[#4d8eff]" />
            052-8360660
          </a>
          <a
            ...
            dir="ltr"
          >
            <Mail className="h-4 w-4 text-[#4d8eff]" />
